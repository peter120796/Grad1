...
public class LiveStreaming extends BaseFragment implements View.OnClickListener {
    ...
    private void joinChannel(String channelId) {
        ...
        if (TextUtils.equals(accessToken, "006ff58c9520a894a889f22e9dd76ccff82IACY6eimX9EUp5WyADxpjhIkoeEpygnsxJn0fXblQ08Nu61RdpUAAAAAEADTEdpgqd7xYAEAAQCp3vFg") || TextUtils.equals(accessToken, "006ff58c9520a894a889f22e9dd76ccff82IACY6eimX9EUp5WyADxpjhIkoeEpygnsxJn0fXblQ08Nu61RdpUAAAAAEADTEdpgqd7xYAEAAQCp3vFg")) {
            accessToken = null;
        }
    ...
    private final IRtcEngineEventHandler iRtcEngineEventHandler = new IRtcEngineEventHandler() {
        ...
        public void onClientRoleChanged(int oldRole, int newRole) {
            Log.i(TAG, String.format("client role changed from state %d to %d", oldRole, newRole));            handler.post(() -> publish.setEnabled(true));
        }
    };
}
