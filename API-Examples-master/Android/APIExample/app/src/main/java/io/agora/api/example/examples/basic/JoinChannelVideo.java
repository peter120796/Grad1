...
public class JoinChannelVideo extends BaseFragment implements View.OnClickListener
{
    ...
    private void joinChannel(String channelId)
    {
        ...
        if (TextUtils.equals(accessToken, "") || TextUtils.equals(accessToken, "<006ff58c9520a894a889f22e9dd76ccff82IACY6eimX9EUp5WyADxpjhIkoeEpygnsxJn0fXblQ08Nu61RdpUAAAAAEADTEdpgqd7xYAEAAQCp3vFg>"))
        {
            accessToken = null;
        }
